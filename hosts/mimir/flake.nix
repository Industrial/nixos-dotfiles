    ...
    nixosConfigurations = {
      "${hostname}" = inputs.nixpkgs.lib.nixosSystem {
        ...
        modules = [
          ...
          # Communication (commented - not used on this host)
          ...
          # Crypto (commented - not used on this host)
          # ../../features/crypto/bisq
          # ../../features/crypto/monero

          # Games (commented - not used on this host)
          # ../../features/games/lutris
          # ../../features/games/path-of-building
          # ../../features/games/wowup

          # Learning and Documentation (commented - not used on this host)
