{
  ...
  outputs = inputs@{ flake-parts, nix-darwin, ... }: let
    settings = {
      hostname = "smithja";
      stateVersion = "24.05";
  ...
  in flake-parts.lib.mkFlake { inherit inputs; } {
    ...
    flake = {
      darwinConfigurations = {
        smithja = nix-darwin.lib.darwinSystem {
          # inherit system;
          system = "aarch64-darwin";
          specialArgs = {
            inherit inputs;
          ...
          modules = [
            ...
            # ansifilter.packages.${system}.default
            ../../features/cli/aria2
            ../../features/cli/bat
            ../../features/cli/btop
            ../../features/cli/direnv
    ...
    perSystem = { self', inputs', pkgs, system, config, ... }: {
      # darwinConfigurations = import ./darwinConfigurations.nix { inherit inputs settings pkgs; };
      # # nixosConfigurations = import ./nixosConfigurations.nix { inherit inputs settings pkgs; };
