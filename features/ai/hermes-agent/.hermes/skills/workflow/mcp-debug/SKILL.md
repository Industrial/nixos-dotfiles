...
name: mcp-debug
description: >-
  Use the MCP Debug Server to inspect and debug MCP tool calls (create debug session, list tools, trace calls). Use when MCP servers misbehave or return unexpected shapes.
---
