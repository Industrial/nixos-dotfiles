...
name: mcp-debug
description: >
  Use the MCP Debug Server for interactive debugging sessions.
  Create a debug session, set breakpoints, start debugging, and interactively debug code.
tags: [debugging, mcp, breakpoints, stepping]
---

# MCP Debug Server Usage
