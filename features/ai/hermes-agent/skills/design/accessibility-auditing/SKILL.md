...
- Do not rely solely on automated tools — manual verification is essential
- Some issues only appear with assistive technology — test with screen readers if possible
- Do not fix cosmetic issues at the expense of functional accessibility

## See Also

- references/accessibility-auditing-conventions.md

## Templates

- templates/accessibility-fix-templates.md
