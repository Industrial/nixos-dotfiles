...
const GLOBAL_PARAMS: ParamSpec[] = [
    ...
    },
    {
        name: "directory",
        type: "string",
        description: "Run bd in the specified directory (-C).",
        shortFlag: "C",
    },
    {
        name: "doltAutoCommit",
        type: "string",
        description: "Dolt auto-commit policy (off, on, batch).",
        flag: "dolt-auto-commit",
    },
    {
        name: "global",
        type: "boolean",
        description: "Use the global shared-server database.",
        flag: "global",
    },
    {
        name: "json",
