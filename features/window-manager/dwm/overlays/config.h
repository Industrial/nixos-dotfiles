...
static const Layout layouts[] = {
	...
	{ "[]=",      tile },                   // Default: Master and Stack
	{ "[C]",      centeredmaster },         // Centered Master
	{ "[M]",      monocle },                // Fullscreen
	{ "[F]",      centeredfloatingmaster }, // Centered Floating Master
	{ "><>",      NULL },                   // Floating
	{ NULL,       NULL },                   // CycleLayouts Patch
};

static const int taglayouts[] = { 0, 0, 1, 1, 1, 0, 0, 1, 1 };
